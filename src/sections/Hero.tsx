...
export default function Hero() {
  ...
  const mockTelemetryLogs = [
    "[KCG-CORE] SOVEREIGN ARCHITECTURE - NOMINAL",
    "[KRYPTON-AI] COGNITIVE LAYER & INTELLIGENT AGENTS - ACTIVE",
    "[FIKO-ONE] MULTISERVICE SUPER APP ECOSYSTEM - ONLINE",
    "[FIKO-CONNECT] WHATSAPP BUSINESS ORCHESTRATION - ACTIVE"
  ];
      ...
      <section className="relative min-h-screen w-full flex flex-col justify-between overflow-hidden bg-transparent text-white select-none">
        ...
        <div className="absolute inset-0 z-10 pointer-events-none">
          ...
          <div className="absolute top-28 left-8 hidden lg:flex flex-col font-mono text-[9px] text-neutral-500 tracking-wider space-y-1">
            ...
            <div>LAT: { (4.53 + mousePos.y * 0.1).toFixed(4) }Â° N</div>
            <div>LON: { (-4.02 + mousePos.x * 0.15).toFixed(4) }Â° W</div>
            <div>ALT: 812.4m</div>
          </div>
        ...
        <div className="relative z-10 flex-grow flex flex-col items-center justify-center px-6 pt-32 pb-16">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            >
              ...
              KOFFMANN CAPITAL GROUP â€¢ SOUVERAINETÃ‰ CONTINENTALE
            </motion.div>
            ...
            <div className="space-y-4">
              ...
              >
                <span className="block italic text-white/50 mb-4 text-lg sm:text-xl md:text-2xl tracking-[0.2em] lowercase font-sans font-light normal-case">
                  Nous ne construisons pas de plateformes pÃ©riphÃ©riques.
                </span>
            ...
            >
              KOFFMANN CAPITAL GROUP orchestre la fusion systÃ©mique des ressources stratÃ©giques, de la logistique d'approvisionnement et de l'intelligence algorithmique pour propulser l'essor industriel de l'Afrique.
            </motion.p>
        ...
        <div className="max-w-[1440px] mx-auto px-6 grid md:grid-cols-12 gap-12 relative z-10 items-center">
          ...
          <div className="md:col-span-7 text-left space-y-6">
            <p className="text-lg md:text-xl text-neutral-300 font-light leading-relaxed">
              MatiÃ¨res critiques, structures de paiements autonomes, et liaisons logistiques paneuropÃ©ennes. Nous mettons en Å“uvre les architectures d'indÃ©pendance financiÃ¨re du futur.
            </p>
            <p className="text-sm md:text-base text-neutral-500 font-light leading-relaxed">
              En raffinant localement les gisements d'Afrique et en automatisant la prise de dÃ©cision stratÃ©gique par l'IA, KOFFMANN CAPITAL GROUP transforme l'Ã©conomie physique en un rÃ©seau cybernÃ©tique hautement efficient.
            </p>
          </div>
